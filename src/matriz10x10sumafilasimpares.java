 ...
 * @author Andertaker
 */
public class matriz10x10sumafilasimpares {
    ...
    public static void main(String[] args) {
        ...
        for(int j=0;j<matriz.length;j++){
            if(j%2==1){
        System.out.println("La suma de la filas impares: "+j+"es: "+sumafilaspar[j]);
            }
        } 
    }
